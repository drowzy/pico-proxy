...
PicoProxy.prototype.listen = function (port, cb) {
  port = port || 8080;
  this._proxy.listen(port || 8080, function () {
    console.log('Listening on port: ' + port);
    console.log('Target is: ' + this._targetProtocol + '://' + this._target);
    console.log('Outgoing requests are sent with: ' + this._targetProtocol);
    console.log('Proxy server in using protocol: ' + this._protocol);
